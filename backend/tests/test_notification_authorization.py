...
class TestNotificationAuthorization:
    ...
    def test_mark_read_rejects_nonexistent_notification(self, mock_reports_db, current_user):
    ...
    def test_mark_read_rejects_other_user_notification(self, mock_reports_db, current_user):
    ...
    def test_mark_read_allows_own_notification(self, mock_reports_db, current_user):
    ...
    def test_mark_read_verifies_ownership_before_mutation(self, mock_reports_db, current_user):
    ...
    def test_mark_read_403_not_404_for_unauthorized(self, mock_reports_db, current_user):
