...
class TestUploadSizeValidation:
    ...
    def test_upload_size_rejects_zero(self, valid_metadata):
        ...
        with pytest.raises(ValidationError) as exc_info:
            UploadInitRequest(study_metadata=valid_metadata, total_files=1, total_size_bytes=0)
    ...
    def test_upload_size_rejects_negative(self, valid_metadata):
        ...
        with pytest.raises(ValidationError) as exc_info:
            UploadInitRequest(study_metadata=valid_metadata, total_files=1, total_size_bytes=-1000)
    ...
    def test_upload_size_rejects_exceeds_max(self, valid_metadata):
        ...
        with pytest.raises(ValidationError) as exc_info:
            UploadInitRequest(
                study_metadata=valid_metadata, total_files=1, total_size_bytes=too_large
            )
    ...
    def test_upload_size_accepts_exactly_max(self, valid_metadata):
        ...
        request = UploadInitRequest(
            study_metadata=valid_metadata, total_files=1, total_size_bytes=max_size
        )
    ...
    def test_upload_size_accepts_valid_small(self, valid_metadata):
        ...
        request = UploadInitRequest(
            study_metadata=valid_metadata, total_files=1, total_size_bytes=small_size
        )
    ...
    def test_upload_size_accepts_valid_large(self, valid_metadata):
        ...
        request = UploadInitRequest(
            study_metadata=valid_metadata, total_files=1, total_size_bytes=large_size
        )
