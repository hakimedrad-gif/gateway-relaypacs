...
import pytest
from app.exceptions import ChunkUploadError, DicomProcessingError, PACSConnectionError, StorageError
...
class TestCustomExceptions:
    ...
    def test_all_exceptions_inherit_from_relay_pacs_error(self):
        ...
        exceptions = [DicomProcessingError, StorageError, PACSConnectionError, ChunkUploadError]
...
class TestStructuredLogging:
    ...
    def test_log_includes_file_id_context(self):
        ...
        with patch.object(logger, "error") as mock_error:
            logger.error(
                "Test error", exc_info=True, extra={"upload_id": "test123", "file_id": "file456"}
            )
